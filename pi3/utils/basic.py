...
def load_images_as_tensor_pi_long(image_paths, image_width=None, PIXEL_LIMIT=255000):
    """
    ...
    # --- 1. Load images from the provided list of paths ---
    ...
    if image_width is None or image_width == -1:
        ...
        target_scale = target_width / W_orig
        W_target, H_target = target_width, H_orig * target_scale
